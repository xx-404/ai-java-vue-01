...
) ENGINE = InnoDB AUTO_INCREMENT = 1843 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'API访问统计日志' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_api_access_log` VALUES (1835, '2026-06-07 10:29:33', '2026-06-07 10:29:33', '/api/sys/config-group/public', 'GET', 200, 1, 3, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1836, '2026-06-07 10:29:33', '2026-06-07 10:29:33', '/api/crypto/config', 'GET', 200, 1, 122, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1837, '2026-06-07 10:29:33', '2026-06-07 10:29:33', '/api/sys/config-group/public', 'GET', 200, 1, 111, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1838, '2026-06-07 10:29:33', '2026-06-07 10:29:33', '/api/sys/config-group/public', 'GET', 200, 1, 2, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1839, '2026-06-07 10:29:34', '2026-06-07 10:29:34', '/api/auth/captcha', 'GET', 200, 1, 677, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1840, '2026-06-07 10:29:43', '2026-06-07 10:29:43', '/api/auth/login', 'POST', 200, 1, 217, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1841, '2026-06-07 10:29:43', '2026-06-07 10:29:43', '/api/auth/captcha', 'GET', 200, 1, 8, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1842, '2026-06-07 10:29:51', '2026-06-07 10:29:52', '/api/auth/login', 'POST', 200, 1, 19, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1843, '2026-06-07 10:29:52', '2026-06-07 10:29:52', '/api/auth/captcha', 'GET', 200, 1, 6, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1844, '2026-06-07 10:30:20', '2026-06-07 10:30:20', '/api/auth/login', 'POST', 200, 1, 50, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1845, '2026-06-07 10:30:20', '2026-06-07 10:30:20', '/api/auth/captcha', 'GET', 200, 1, 13, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1846, '2026-06-07 10:30:34', '2026-06-07 10:30:34', '/api/auth/captcha', 'GET', 200, 1, 7, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1847, '2026-06-07 10:30:39', '2026-06-07 10:30:39', '/api/auth/login', 'POST', 200, 1, 33, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1848, '2026-06-07 10:30:39', '2026-06-07 10:30:39', '/api/auth/captcha', 'GET', 200, 1, 8, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1849, '2026-06-07 10:47:15', '2026-06-07 10:47:15', '/api/crypto/config', 'GET', 200, 1, 118, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1850, '2026-06-07 10:47:15', '2026-06-07 10:47:15', '/api/sys/config-group/public', 'GET', 200, 1, 5, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1851, '2026-06-07 10:47:15', '2026-06-07 10:47:15', '/api/sys/config-group/public', 'GET', 200, 1, 119, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1852, '2026-06-07 10:47:15', '2026-06-07 10:47:15', '/api/sys/config-group/public', 'GET', 200, 1, 3, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1853, '2026-06-07 10:47:15', '2026-06-07 10:47:16', '/api/auth/captcha', 'GET', 200, 1, 164, '127.0.0.1', NULL);
INSERT INTO `sys_api_access_log` VALUES (1854, '2026-06-07 10:47:24', '2026-06-07 10:47:25', '/api/auth/login', 'POST', 200, 1, 276, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1855, '2026-06-07 10:47:25', '2026-06-07 10:47:25', '/api/auth/info', 'GET', 200, 1, 102, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1856, '2026-06-07 10:47:25', '2026-06-07 10:47:25', '/api/sys/notice/unread-count', 'GET', 200, 1, 22, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1857, '2026-06-07 10:47:25', '2026-06-07 10:47:25', '/api/sys/chat/unread-count', 'GET', 200, 1, 22, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1858, '2026-06-07 10:47:25', '2026-06-07 10:47:25', '/api/dashboard/stats', 'GET', 200, 1, 45, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1859, '2026-06-07 10:47:34', '2026-06-07 10:47:34', '/api/sys/config-group/list', 'GET', 200, 1, 26, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1860, '2026-06-07 10:47:34', '2026-06-07 10:47:34', '/api/sys/config-group/sms-logs/recent', 'GET', 200, 1, 27, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1861, '2026-06-07 10:47:34', '2026-06-07 10:47:34', '/api/sys/config-group/system', 'GET', 200, 1, 7, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1862, '2026-06-07 10:47:36', '2026-06-07 10:47:36', '/api/sys/config-group/register', 'GET', 200, 1, 3, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1863, '2026-06-07 10:47:37', '2026-06-07 10:47:37', '/api/sys/config-group/login', 'GET', 200, 1, 1, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1864, '2026-06-07 10:47:39', '2026-06-07 10:47:39', '/api/sys/config-group/login', 'POST', 200, 1, 42, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1865, '2026-06-07 10:47:39', '2026-06-07 10:47:39', '/api/sys/config-group/password', 'GET', 200, 1, 0, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1866, '2026-06-07 10:47:41', '2026-06-07 10:47:41', '/api/sys/config-group/email', 'GET', 200, 1, 0, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1867, '2026-06-07 10:47:41', '2026-06-07 10:47:41', '/api/sys/config-group/emailTemplate', 'GET', 200, 1, 2, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1868, '2026-06-07 10:47:42', '2026-06-07 10:47:42', '/api/sys/config-group/sms', 'GET', 200, 1, 1, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1869, '2026-06-07 10:47:42', '2026-06-07 10:47:42', '/api/sys/config-group/storage', 'GET', 200, 1, 1, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1870, '2026-06-07 10:47:43', '2026-06-07 10:47:43', '/api/sys/config-group/push', 'GET', 200, 1, 2, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1871, '2026-06-07 10:47:43', '2026-06-07 10:47:43', '/api/sys/config-group/thirdParty', 'GET', 200, 1, 1, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1872, '2026-06-07 10:47:45', '2026-06-07 10:47:45', '/api/sys/config-group/security', 'GET', 200, 1, 1, '127.0.0.1', 1);
INSERT INTO `sys_api_access_log` VALUES (1873, '2026-06-07 10:47:46', '2026-06-07 10:47:46', '/api/sys/config-group/security', 'POST', 200, 1, 34, '127.0.0.1', 1);
...
INSERT INTO `sys_config_group` VALUES (3, 'login', '登录配置', NULL, '{\"captchaEnabled\":false,\"captchaType\":\"image\",\"maxRetryCount\":5,\"lockTime\":30,\"rememberMe\":true,\"singleLogin\":false}', 3, 1, NULL, '2026-01-31 14:38:29', '2026-01-31 15:38:39');
...
INSERT INTO `sys_login_log` VALUES (286, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-06-07 10:47:25');
...
CREATE TABLE `sys_menu`  (
  ...
  `deleted` tinyint NULL DEFAULT 0 COMMENT '删除标识(0-未删除 1-已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 501 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (500, 6, '复制角色', 3, NULL, NULL, 'sys:role:copy', NULL, 4, 1, 1, 0, '2026-06-02 20:00:00', '2026-06-02 20:00:00', NULL, NULL, 0);
...
-- ----------------------------
-- Table structure for sys_user_table_preference
-- ----------------------------
DROP TABLE IF EXISTS `sys_user_table_preference`;
CREATE TABLE `sys_user_table_preference`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `page_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '页面标识(如: system/user)',
  `columns_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '列配置JSON',
  `page_size` int NULL DEFAULT 10 COMMENT '每页条数',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_by` bigint NULL DEFAULT NULL COMMENT '创建人',
  `update_by` bigint NULL DEFAULT NULL COMMENT '更新人',
  `deleted` tinyint NULL DEFAULT 0 COMMENT '删除标识(0-未删除 1-已删除)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_page`(`user_id` ASC, `page_key` ASC, `deleted` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_page_key`(`page_key` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户表格偏好设置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user_table_preference
-- ----------------------------
